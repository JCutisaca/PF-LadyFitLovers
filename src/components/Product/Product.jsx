...
const Product = ({
  ...
  const productWithoutStock = stock.every((stock) =>
    stock.sizeAndQuantity.every(
      (sizeAndQuantity) => sizeAndQuantity.quantity === 0
    )
  );
        ...
        <div className={style.card}>
          ...
          <NavLink to={`/detail/${id}`}>
            <div className={style.imgBx}>
              {productWithoutStock ? (
                <h3 className={style.outOfStock}>SIN STOCK</h3>
              ) : null}
